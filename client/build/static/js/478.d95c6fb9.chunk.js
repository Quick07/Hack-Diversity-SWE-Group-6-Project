'use strict';
(self.webpackChunkteam6project = self.webpackChunkteam6project || []).push([
  [478],
  {
    478: function (n, e, t) {
      t.r(e),
      ...
      var r,
        ...
        F = function (n, e) {
          r ||
            ((r = e), (i = n), (o = new Date()), D(removeEventListener), k());
        },
        k = function () {
          if (i >= 0 && i < o - A) {
            var n = {
          ...
          (e = e || {}),
            w(function () {
              var t,
                ...
                c = l('FID'),
                s = function (n) {
                  n.startTime < u.firstHiddenTime &&
                    ((c.value = n.processingStart - n.startTime),
                    c.entries.push(n),
                    t(!0));
                },
                d = function (n) {
        ...
        J = function (n) {
          var e = z[z.length - 1],
            t = G[n.interactionId];
          if (t || z.length < 10 || n.duration > e.latency) {
            if (t)
            ...
            z.sort(function (n, e) {
              ...
              z.splice(10).forEach(function (n) {
                delete G[n.id];
              });
          }
        },
            ...
            w(function () {
              ...
              var r,
                ...
                o = function (n) {
                  ...
                  var e,
                    t =
                      ((e = Math.min(z.length - 1, Math.floor(_() / 50))),
                      z[e]);
                  t &&
                    t.latency !== i.value &&
          ...
          (e = e || {}),
            w(function () {
              ...
              if (u) {
                ...
                var c = g(function () {
                  Q[o.id] ||
                    (a(u.takeRecords()), u.disconnect(), (Q[o.id] = !0), t(!0));
                });
                ['keydown', 'click'].forEach(function (n) {
                  addEventListener(n, c, !0);
                }),
                  h(c),
                  f(function (i) {
                    (o = l('LCP')),
          ...
          V(function () {
            ...
            if (o) {
              ...
              (r.value = Math.max(a - d(), 0)),
                ...
                i(!0),
                f(function () {
                  (r = l('TTFB', 0)), (i = v(n, r, t, e.reportAllChanges))(!0);
                });
            }
          });
        };
...
//# sourceMappingURL=478.d95c6fb9.chunk.js.map
